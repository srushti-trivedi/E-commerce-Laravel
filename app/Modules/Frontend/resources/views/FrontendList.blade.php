	<title> PhoneWorld | Products | List </title>
									...
									<div class="images-container">
										<div class="product-hover">
											...
											<a href="{{ url('/products/'.$product->url) }}" title="Configurable Product" class="product-image">
												<img id="product1" src="{{ asset('uploads/cover/'.$product->coverImg) }}" class="img-responsive" width="278" height="355" alt="Products"> 
											...
											<div class="product-hover-box">
												<a class="detail_links" title="Product Details" href="{{ url('/products/'.$product->url) }}"></a>
