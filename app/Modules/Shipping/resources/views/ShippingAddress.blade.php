	...
	<div class="woocommerce">
		<div class="container">
			...
			<div class="checkout-step-process">
				<ul>
					<li>
						<div class="step-process-item"><i data-href="checkout-step2.html"  class="fa fa-check step-icon"></i><span class="text">Address</span></div>
					</li>
					<li>
			...
			<form name="checkout" method="POST" class="checkout woocommerce-checkout form-in-checkout" action="{{ url('addShipping') }}" enctype="multipart/form-data">
				@csrf
				<ul class="row">
					<li class="col-md-9">
							...
							<ul>
								...
								@endforeach
									<span class="radio-show">
										<input type="radio" class="shippingAdress" name="shipping-address" value="addNewAddress" id="addnew">
