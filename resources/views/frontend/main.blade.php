	...
	<div class="wrapper">
		<div class="page">
																		...
																		<ul class="mage-column cat-mega">
																			...
																			<li class="children">
																				<ul>
																					...
																					<li class="nav"><a href="#">Sunglabani/asses </a></li>
																					<li class="nav"><a href="#">Sweaters </a></li>
										...
										<form id="search_mini_form" action="#" method="get">
											<div class="form-search clearfix"> 
												...
												<select class="ddslick"  id="cat" name="cat">
													...
													<option value="151">-&nbsp;-Sunglabani/asses</option>
													...
													<option value="307">-&nbsp;-Sunglabani/asses</option>
			...
			<div class="main-container col1-layout content-color color">
					...
					<div class="container-none flex-index">
						<div class="flexslider">
							<div id="slider-index" class="slides">
								<div class="item"> 
									<a  href="#"><img src="abani/assets/images/slide1.jpg" alt="magicslider"></a>
									<div class="bx-caption start play">
										<div class="container">
											<div class="text-slide">
												...
												<a href="#" class="btn-shop caption4">Shop Now</a>
											</div>
										</div>
									</div>
								</div>
								<div class="item"> 
									<a  href="#"><img src="abani/assets/images/slide2_1.jpg" alt="magicslider"></a>
								...
								<div class="item">
									<a  href="#"> <img src="abani/assets/images/slide3_2.jpg" alt="magicslider"> </a>
									<div class="bx-caption ">
										<div class="container">
							...
							<div class="col-main col-lg-12">
								<div class="block block-subscribe popup" style="display:none;">
									<div id="popup-newsletter"> 
										<a href="abani/assets/images/popup-newletter.jpg"></a>
										<form action="#" method="post" id="popup-newsletter-validate-detail">
											<div class="block-content">
												<img src="abani/assets/images/logo-newletter.png" alt=""/>
				...
				{{--  show offer available time in clock way 		 --}}

				{{-- <div class="block-static block_deal">
					<div class="deal-of">
						<img class="img-responsive" alt="" src="abani/assets/images/img-dea.png" />
						<div class="deal">
							<div class="container">
								<div class="heading">
