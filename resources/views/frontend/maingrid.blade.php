					...
					<div class="main">
						<div class="row">
							...
							<div class="col-main col-lg-9 col-md-9 col-sm-9 col-xs-12 content-color color">
								...
								<p class="category-image"><img src="abani/assets/images/categories_grid_1.jpg" alt="Men" title="Men"></p>
								<div class="category-products">
									<div class="toolbar">
										<div class="sorter">
											<p class="view-mode"> <label>View as:</label> <a href="javascript:void(0)" title="Grid" class="grid active"> <i class="icon-grid icons"></i> </a> <a data-href="list.html" title="List" class="redirectjs list"> <i class="icon-list icons"></i> </a></p>
											<div class="sort-by">
												<label>Sort By</label> 
												<select>
											...
											<div class="category-products-grid">
												...
												<div class="product-info products-textlink clearfix">
													...
													<ul class="configurable-swatch-list configurable-swatch-color clearfix">
														<li class="option-blue is-media"> <a href="javascript:void(0)" name="blue" class="swatch-link swatch-link-92 has-image" title="blue"> <span class="swatch-label"> <img src="abani/assets/images/blue.png" alt="blue" height="15" width="15"> </span> </a></li>
														<li class="option-red is-media"> <a href="javascript:void(0)" name="red" class="swatch-link swatch-link-92 has-image" title="red"> <span class="swatch-label"> <img src="abani/assets/images/red.png" alt="red" height="15" width="15"> </span> </a></li>
													</ul>
										...
										<li class="col-lg-4 col-md-4 col-sm-6 col-xs-6 col-mobile-12 item">
											<div class="category-products-grid">
												...
												<div class="product-info products-textlink clearfix">
													...
													<ul class="configurable-swatch-list configurable-swatch-color clearfix">
														<li class="option-black is-media"> <a href="javascript:void(0)" name="black" class="swatch-link swatch-link-92 has-image" title="black"> <span class="swatch-label"> <img src="abani/assets/images/black.png" alt="black" height="15" width="15"> </span> </a></li>
														<li class="option-blue is-media"> <a href="javascript:void(0)" name="blue" class="swatch-link swatch-link-92 has-image" title="blue"> <span class="swatch-label"> <img src="abani/assets/images/blue.png" alt="blue" height="15" width="15"> </span> </a></li>
													</ul>
